...
//                   $(".Sucess").html("<i class='fa fa-check'></i> Dear <b>" + name + "</b> Thank you for your inquiry we will respond to you as soon as possible!");
                   $(".Sucess").html("<i class='fa fa-check'></i> Уважаемый <b>" + name + "</b> Спасибо за Ваше обращение, мы скоро свяжемся с Вами!");
//                    $(".Sucess").html("<i class='fa fa-check'></i> Уважаемый <b>" + name, + "</b> Спасибо за Ваше обращение!");
                    $("#Name").val("");
                    $("#Email").val("");
                    $("#hero").val("");
                    $("#Message").val("");
